...
&kp Q,             &kp W,             &kp E,          U_LT(U_NUM, R),       &kp T,             &kp Y,          U_LT(U_FUN, U),             &kp I,             &kp O,             &kp P,             \
U_MT(LGUI, A),   U_MT(LALT, S),     U_MT(LCTRL, D),   U_MT(LSHFT, F),    U_LT(U_NUM, G),   U_LT(U_NAV, H),     U_MT(LSHFT, J),         U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
...
// U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MT(LSHFT, T), U_LT(U_NUM, G),  U_LT(U_NAV, M),         U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
